The ItemActors folder contains the actor verison of Items so they can be placed in the level.

The Items folder contains UObjects that can be added to the player inventory.
